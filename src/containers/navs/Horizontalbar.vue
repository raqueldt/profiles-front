<template>
  <div class="sidebar" @click.stop="()=>{}">
    ...
    <div class="main-menu w-50" style="height: 45px !important; border:solid 1px red;">
      <vue-perfect-scrollbar
        class="scroll"
        :settings="{ suppressScrollX: true, wheelPropagation: false }"
      >
        
          <span style="border-right: 2px gray;"
  ...
  watch: {
    $route(to, from) {
      if (to.path !== from.path) {
        ...
        //if (toParentUrl !== undefined || toParentUrl !== null || Boolean(toParentUrl)) {
        if (Boolean(toParentUrl)) {
