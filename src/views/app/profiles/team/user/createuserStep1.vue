        ...
        <b-row>
          ...
          <b-col cols="12" md="4">
            <b-form-group label-for="lastname">
              ...
              <b-form-input v-model="formData.lastname" id="lastname" placeholder="Ingrese su apellido" required />
            </b-form-group>
          </b-col>
          ...
          <b-col cols="12" md="4">
            <b-form-group label-for="email">
              ...
              <b-form-input v-model="formData.email" id="email" placeholder="Ingrese su correo electrónico" required />
            </b-form-group>
          </b-col>
        </b-row>
        <b-row>
          <b-col cols="12" md="4">
            <b-form-group label-for="roles">
              ...
              <b-form-select v-model="formData.roles" id="roles" :options="roles" multiple filter class="mb-3" required />
            </b-form-group>
          </b-col>
          ...
          <b-col cols="12" md="4">
            <b-form-group label-for="username">
              ...
              <b-form-input v-model="formData.username" id="username" placeholder="Ingrese su nombre de usuario" required />
            </b-form-group>
          </b-col>
          ...
          <b-col cols="12" md="4">
            <b-form-group label-for="password">
              ...
              <b-form-input v-model="formData.password" id="password" type="password" placeholder="Ingrese su contraseña" required />
            </b-form-group>
          </b-col>
        </b-row>
      </b-card>
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      // Validar el formulario y establecer isFormValid en true o false
      if (
        this.formData.name !== '' &&
  ...
  mounted() {
    this.getRoles();
    this.validateForm(); // Llamar a la validación inicial del formulario
  },
  watch: {
    formData: {
      deep: true,
