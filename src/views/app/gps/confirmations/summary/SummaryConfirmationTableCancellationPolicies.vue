<template>
  <b-card class="shadow">
            <h6>{{$t('gps.cancelation_policy')}}</h6>
            ...
            <!-- Modal para asignacion de Opeadores masivamente --> 
                ...
                <table class="table table-striped table-bordered table-sm">
                  ...
                  <tbody>
                    <tr v-for="(item, index) in politicasAplicadas" :key="index" >   
                      ...
                      <td class="text-center text-muted">
                        <small>{{calculateCancelationMount(cotValor, item.ccxPorcentaje)  | currency}}</small>
                      </td>                    
                ...
                <div v-else>
                      <b-alert show variant="warning">{{ $t('gps.confirmationslabels.no-cancellation-policies') }}</b-alert>                
                </div>
