...
export default {
  ...
  methods: {
    ...
    ...mapActions("cruise-sales-overview", ["fetchCruiseSalesTargets"]),
    ...
    async loadData(){
     ...
     // await this.fetchCruiseSalesTargets( params )


      const { data } = await ReportsServices.getCruiseSalesOverview( params )
