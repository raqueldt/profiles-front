...
export default {
    ...
    computed: {
        ...
        getTotalPax() {
            ...
            //sumar pax
            return this.details.map( item => Number(item.cofPasajeros)).reduce( sumar , 0)
        ...
        getTotalSale(){
            ...
            function sumar(total, valor) { return total + valor }
            //sumar pax
            return this.details.map( item => Number(item.venta)).reduce( sumar , 0)
