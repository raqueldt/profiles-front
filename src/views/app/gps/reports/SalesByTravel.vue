    ...
    <b-row v-if="summaryViewActive">
        <b-col>
            <b-card>
                     ...
                     <b-card-title>Sales by Travel</b-card-title>
...
import SalesTravelDetails from './SalesTravelDetails.vue'
...
export default {
    ...
    data() {
        ...
        sortDesc: false,
            ...
            fields: [
              {key: 'month', label: '#'},
              {key: 'interval', label: 'Confirmation date', thClass: 'text-left'},
    ...
    computed: {
      ...
      ...mapGetters('salesbyTravel', ['getData', 'getClients']),
    ...
    methods: {
      ...
      ...mapActions( 'salesbyTravel', ['loadData']),
