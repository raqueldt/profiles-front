            ...
            <div class="form-side">
                ...
                <b-form @submit.stop.prevent="formSubmit" class="av-tooltip tooltip-label-bottom">
                    <b-form-group :label="$t('user.username')" class="has-float-label mb-4">
                        <b-form-input type="text" v-model="$v.form.username.$model" :state="!$v.form.username.$error" autocomplete="off" @keyup.enter="formSubmit"/>
                        <b-form-invalid-feedback v-if="!$v.form.username.required">Please enter your username</b-form-invalid-feedback>
                        <b-form-invalid-feedback v-else-if="!$v.form.username.minLength">Your username must be minimum 4 characters</b-form-invalid-feedback>
                    </b-form-group>

                    <b-form-group :label="$t('user.password')" class="has-float-label mb-4">
                        <b-form-input type="password" v-model="$v.form.password.$model" :state="!$v.form.password.$error" @keyup.enter="formSubmit"/>
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        ...
                        <b-button
                                    ...
                                    variant="primary"
                                    size="lg"
                                    :disabled="!validateUsernameAndPassword"
                    ...
                    password: this.form.password
                        ...
                        authServices.userinfo(data)
                            .then(response => {
                              ...
                              //2023-03-01 | fg | guadar auth user data en state
                              ...
                              if(Boolean(item)) this.$router.replace({name: "dashboard"}).catch(err => {})
